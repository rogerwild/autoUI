...
public class VideoDetialPageUI extends BasePageUI{
	 ...
	 * 返回按钮
	 */
	public static final CommonUIBean BACK = new CommonUIBean(GetElementWay.NAME, "", "返回/去小屏按钮");
	
	/**
	 * 下载按钮
	 */
	public static final CommonUIBean DOWNLOAD = new CommonUIBean(GetElementWay.NAME, "xiazai", "PLAYER DOWNLOAD");
	/**
	 * 缓存面板
	 */
